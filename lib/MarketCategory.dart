...
class _AddDocumentScreenState extends State<AddDocumentScreen> {
    ...
    if (documentName.isNotEmpty) {
      if (documentNames.any((name) => name.toLowerCase() == documentName)) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Category "$documentName" already exists.'),
        ));
      } else {
        FirebaseFirestore.instance.collection('shareCategory').doc(documentName).set({
  ...
  void _deleteDocument(String documentName) {
    FirebaseFirestore.instance.collection('shareCategory').doc(documentName).delete().then((_) {
